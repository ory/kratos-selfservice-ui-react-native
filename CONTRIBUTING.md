...
1. Ensure that each commit has a descriptive prefix. This ensures a uniform
   ...
   [list of prefixes for Kratos SelfService UI React Native Example](https://github.com/ory/kratos-selfservice-ui-react-native/blob/master/.github/semantic.yml)
   for an overview.
