...
won't clash or be obviated by ORY Kratos SelfService UI React Native Example's normal direction. A great way to
do this is via
[ORY Kratos SelfService UI React Native Example Discussions](https://github.com/ory/Kratos SelfService UI React Native Example/discussions) or
the [ORY Chat](https://www.ory.sh/chat).

## FAQ

- I am new to the community. Where can I find the
  [ORY Community Code of Conduct?](https://github.com/ory/Kratos SelfService UI React Native Example/blob/master/CODE_OF_CONDUCT.md)
...
- I would like to know what I am agreeing to when I contribute to ORY
  Kratos SelfService UI React Native Example. Does ORY have
...
[list of good first issues](https://github.com/ory/Kratos SelfService UI React Native Example/labels/good%20first%20issue).
...
- **Give us a star.** It may not seem like much, but it really makes a
  ...
  Kratos SelfService UI React Native Example. Github stars help the project gain visibility and stand out.
...
Check out
[ORY Kratos SelfService UI React Native Example Discussions](https://github.com/ory/Kratos SelfService UI React Native Example/discussions).
...
[docs](https://github.com/ory/Kratos SelfService UI React Native Example/tree/master/docs) folder. Generate API
and configuration reference documentation using `cd docs; npm run gen`.

For further instructions please head over to
[docs/README.md](https://github.com/ory/Kratos SelfService UI React Native Example/blob/master/README.md).
...
git clone git@github.com:ory/Kratos SelfService UI React Native Example.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/Kratos SelfService UI React Native Example.git
...
- Private harassment is also unacceptable. No matter who you are, if you feel
  ...
  Kratos SelfService UI React Native Example core team immediately.
