...
# Contribute to Ory Kratos SelfService UI React Native Example<!-- omit in toc -->
...
Kratos SelfService UI React Native Example's direction. A great way to
do this is via
...
- **Help with open issues.** We have a lot of open issues for Ory Kratos SelfService UI React Native Example and
