...
# Contributing to Ory Kratos SelfService UI React Native Example
...
_Please note_: We take Ory Kratos SelfService UI React Native Example's security and our users' trust very seriously. If you believe you have found a security issue
in Ory Kratos SelfService UI React Native Example, please responsibly disclose by contacting us at security@ory.sh.
...
Kratos SelfService UI React Native Example's normal direction. A great way to
do this is via
[Ory Kratos SelfService UI React Native Example Discussions](https://github.com/orgs/ory/discussions) or the
[Ory Chat](https://www.ory.sh/chat).

## FAQ

- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/ory/kratos-selfservice-ui-react-native/blob/master/CODE_OF_CONDUCT.md)

- I have a question. Where can I get [answers to questions regarding Ory Kratos SelfService UI React Native Example?](#communication)
...
- I want to talk to other Ory Kratos SelfService UI React Native Example users. [How can I become a part of the community?](#communication)

- I would like to know what I am agreeing to when I contribute to Ory
  Kratos SelfService UI React Native Example.
  Does Ory have
  [a Contributors License Agreement?](https://cla-assistant.io/ory/kratos-selfservice-ui-react-native)

- I would like updates about new versions of Ory Kratos SelfService UI React Native Example.
...
[list of good first issues](https://github.com/ory/kratos-selfservice-ui-react-native/labels/good%20first%20issue).
...
- **Give us a star.** It may not seem like much, but it really makes a difference. This is something that everyone can do to help
  out Ory Kratos SelfService UI React Native Example. Github stars help the project gain visibility and stand out.
...
- **Helping with open issues.** We have a lot of open issues for Ory Kratos SelfService UI React Native Example and some of them may lack necessary information,
...
Check out [Ory Kratos SelfService UI React Native Example Discussions](https://github.com/orgs/ory/discussions). This is a great place for in-depth discussions and lots of code examples, logs
and similar data.
...
If you want to receive regular notifications about updates to Ory Kratos SelfService UI React Native Example, consider joining the mailing list. We will _only_ send
...
[in our chat](https://www.ory.sh/chat) before getting started to ensure your work is consistent with Ory Kratos SelfService UI React Native Example's roadmap and
architecture.
...
1. Ensure that each commit has a descriptive prefix. This ensures a uniform commit history and helps structure the changelog.  
   Please refer to this [list of prefixes for Kratos SelfService UI React Native Example](https://github.com/ory/kratos-selfservice-ui-react-native/blob/master/.github/semantic.yml) for an
   overview.
...
[Contributor License Agreement](https://cla-assistant.io/ory/kratos-selfservice-ui-react-native).
...
5. have signed our [Contributor License Agreement](https://cla-assistant.io/ory/kratos-selfservice-ui-react-native);
...
[docs](https://github.com/ory/kratos-selfservice-ui-react-native/tree/master/docs) folder. Generate API and configuration reference documentation using
`cd docs; npm run gen`.

For further instructions please head over to [docs/README.md](https://github.com/ory/kratos-selfservice-ui-react-native/blob/master/README.md).
...
git clone git@github.com:ory/ory/kratos-selfservice-ui-react-native.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/ory/kratos-selfservice-ui-react-native.git
...
- Private harassment is also unacceptable. No matter who you are, if you feel you have been or are being harassed or made
  uncomfortable by a community member, please contact one of the channel ops or a member of the Ory Kratos SelfService UI React Native Example core team
  immediately.
