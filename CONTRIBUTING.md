...
_Please note_: We take ORY Kratos SelfService UI React Native Example's security and our users' trust very
seriously. If you believe you have found a security issue in ORY Kratos SelfService UI React Native Example,
...
do this is via
[ORY Kratos SelfService UI React Native Example Discussions](https://github.com/ory/meta/discussions)
...
- I have a question. Where can I get
  [answers to questions regarding ORY Kratos SelfService UI React Native Example?](#communication)
...
- I want to talk to other ORY Kratos SelfService UI React Native Example users.
...
- **Give us a star.** It may not seem like much, but it really makes a
  difference. This is something that everyone can do to help out ORY Kratos SelfService UI React Native Example.
...
- **Helping with open issues.** We have a lot of open issues for ORY Kratos SelfService UI React Native Example
...
Check out [ORY Kratos SelfService UI React Native Example Discussions](https://github.com/ory/meta/discussions). This is a great place for
...
If you want to receive regular notifications about updates to ORY Kratos SelfService UI React Native Example,
...
before getting started to ensure your work is consistent with ORY Kratos SelfService UI React Native Example's
...
[docs](https://github.com/ory/kratos-selfservice-ui-react-native/tree/master/docs) folder. Generate API and
configuration reference documentation using `cd docs; npm run gen`.

For further instructions please head over to
[docs/README.md](https://github.com/ory/kratos-selfservice-ui-react-native/blob/master/README.md).
...
1. Ensure that each commit has a subsystem prefix (ex: `controller:`).
   [List of subsystem prefixes for Kratos SelfService UI React Native Example](https://github.com/ory/ory/kratos-selfservice-ui-react-native/blob/master/.github/semantic.yml)
   (if applicable).
...
- Private harassment is also unacceptable. No matter who you are, if you feel
  ...
  member, please contact one of the channel ops or a member of the ORY Kratos SelfService UI React Native Example
